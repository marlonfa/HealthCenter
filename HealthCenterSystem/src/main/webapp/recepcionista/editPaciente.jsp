            ...
            <form id="form">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td colspan="7"> 
                                <input type="text" id="nome" name="nome" placeholder="Digite aqui o nome do Paciente" size="150" maxlength="100" value="${paciente.nome}" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="text" id="naturalidade" name="naturalidade" size="20" placeholder="Digite a naturalidade" maxlength="30" value="${paciente.naturalidade}" />
                            </td>
                            <td>
                                <label>Data Nasc.:</label>
                            </td>
                            <td>
                                <input type="text" id="dataNascimento" name="dataNascimento" size="20" placeholder="__/__/____" value="<fmt:formatDate value="${paciente.dataNascimento}" />" />
                            </td>
                            <td>
                                <label>Sexo:</label>
                            </td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <select id="estadoCivil" name="estadoCivil">
                                    <option value="${paciente.estadoCivil}">${paciente.estadoCivil}</option>
                            ...
                            <td>
                                <input type="text" id="cpf" name="cpf" size="20" placeholder="___.___.___-__" value="${paciente.cpf}" />
                            </td>
                            <td>
                                <label>RG:</label>
                            </td>
                            <td>
                                <input type="text" id="rg" name="rg" size="20" placeholder="__.___.___-_" value="${paciente.rg}" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="8">
                        ...
                        <tr>
                            ...
                            <td colspan="7"> 
                                <input type="text" id="nomeEndereco" name="nomeEndereco" placeholder="Digite aqui o endereço do Paciente" size="140" maxlength="60" value="${paciente.endereco.nomeEndereco}" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="text" id="numeroEndereco" name="numeroEndereco" placeholder="Número" size="20" value="${paciente.endereco.numero}" />
                            </td>
                            <td>
                                <label>Complemento:</label>
                            </td>
                            <td>
                                <input type="text" id="complemento" name="complemento" placeholder="Complemento" size="20" maxlength="30" value="${paciente.endereco.complemento}" />
                            </td>
                            <td>
                                <label>Bairro:</label>
                            </td>
                            <td colspan="3">
                                <input type="text" id="bairro" name="bairro" placeholder="Digite o nome do Bairro" size="20" maxlength="30" value="${paciente.endereco.bairro}"  />
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td colspan="3">
                                <input type="text" id="cidade" name="cidade" placeholder="Digite o nome da cidade" size="70" maxlength="50" value="${paciente.endereco.cidade}" />
                            </td>
                            <td>
                                <label>CEP:</label>
                            </td>
                            <td colspan="3">
                                <input type="text" id="cep" name="cep" placeholder="_____-___" size="20" value="${paciente.endereco.cep}" />
                            </td>
                        </tr>
                        <tr>
                            <td colspan="8">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" id="telefone" name="telefone" placeholder="(__)____-____" size="20" value="${paciente.contato.telefone}" />
                            </td>
                            <td>
                                <label>Celular:</label>
                            </td>
                            <td>
                                <input type="text" id="celular" name="celular" placeholder="(__)____-____" size="20" value="${paciente.contato.celular}" />
                            </td>
                            <td>
                                <label>Email:</label>
                            </td>
                            <td colspan="3">
                                <input type="text" id="email" name="email" placeholder="email@email.com" size="40" value="${paciente.contato.email}" />
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td colspan="7">
                                <input type="password" id="senha" name="senha" placeholder="******" size="20" value="${paciente.usuario.password}" />
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td colspan="7">
                                <input type="password" id="repetirSenha" name="repetirSenha" placeholder="******" size="20" value="${paciente.usuario.password}" />
                            </td>
                        </tr>
                        <input type="hidden" name="tipoOperacao" value="editPaciente2" id="operacao">
                    </table>
