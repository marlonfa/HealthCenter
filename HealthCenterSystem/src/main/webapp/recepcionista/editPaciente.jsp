            ...
            <form id="form">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td colspan="7"> 
                                <input type="text" id="nome" name="nome" placeholder="Digite aqui o nome do Paciente" size="150" value="${paciente.nome}" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="text" id="naturalidade" name="naturalidade" size="20" placeholder="Digite a naturalidade" value="${paciente.naturalidade}" />
                            </td>
                            <td>
                                <label>Data Nasc.:</label>
                            </td>
                            <td>
                                <input type="text" id="dataNascimento" name="dataNascimento" size="20" placeholder="__/__/____" value="${paciente.dataNascimento}" />
                            </td>
                            <td>
                                <label>Sexo:</label>
                            </td>
                        ...
                        <tr>
                            ...
                            <td colspan="7"> 
                                <input type="text" id="nomeEndereco" name="nomeEndereco" placeholder="Digite aqui o endereço do Paciente" size="140" value="${paciente.endereco.nomeEndereco}" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td colspan="3">
                                <input type="text" id="bairro" name="bairro" placeholder="Digite o nome do Bairro" size="20" value="${paciente.endereco.bairro}"  />
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td colspan="3">
                                <input type="text" id="cidade" name="cidade" placeholder="Digite o nome da cidade" size="70" value="${paciente.endereco.cidade}" />
                            </td>
                            <td>
                                <label>CEP:</label>
                            </td>
