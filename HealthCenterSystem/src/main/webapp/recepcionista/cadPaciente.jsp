            ...
            <form id="form">
                    <table>
                        ...
                        <tr>
                            ...
                            <td colspan="7"> 
                                <input type="text" id="nome" name="nome" placeholder="Digite aqui o nome do Paciente" size="150" maxlength="100"/>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td colspan="7"> 
                                <input type="text" id="nomeEndereco" name="nomeEndereco" placeholder="Digite aqui o endereço do Paciente" size="140" maxlength="60"/>
                            </td>
                        </tr>
                        <tr>
                            <td>
                            ...
                            <td>
                                <input type="text" id="numeroEndereco" name="numeroEndereco" placeholder="Número" size="20" maxlength="5"/>
                            </td>
                            <td>
                        ...
                        <input type="hidden" name="tipoOperacao" value="cadPaciente" id="operacao">
                    </table>
