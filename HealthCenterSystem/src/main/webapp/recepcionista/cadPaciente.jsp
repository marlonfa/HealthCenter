            ...
            <form id="form">
                    <table>
                        ...
                        <tr>
                            ...
                            <td colspan="7"> 
                                <input type="text" id="nome" name="nome" placeholder="Digite aqui o nome do Paciente" size="150" />
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td colspan="7"> 
                                <input type="text" id="nomeEndereco" name="nomeEndereco" placeholder="Digite aqui o endereço do Paciente" size="140" />
                            </td>
                        </tr>
                        <tr>
                            <td>
