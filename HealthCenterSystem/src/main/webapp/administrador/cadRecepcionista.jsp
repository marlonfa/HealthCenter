            ...
            <form id="form">
                    <table>
                        ...
                        <tr>
                            ...
                            <td colspan="7"> 
                                <input type="text" id="nome" name="nome" placeholder="Digite aqui o nome do Recepcionista" size="150" maxlength="100"/>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td colspan="7"> 
                                <input type="text" id="nomeEndereco" name="nomeEndereco" placeholder="Digite aqui o endereço do Recepcionista" size="140" maxlength="60"/>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <input type="hidden" name="tipoOperacao" value="cadRecepcionista" id="operacao">
                    </table>
